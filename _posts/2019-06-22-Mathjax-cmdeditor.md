---
title: Mathjax Typora CMD-Editor
layout: post
categories: Writing
tags: Blog Writing Tutorial Paper 
excerpt: Cmd Markdown Formula instruction manual

---
#### Cmd Markdown 公式指导手册 <span id="home">
[TOC]
...
使用 
```
\begin{array}…\end{array}` 和 `\left\{…\right.` 来创建一个方程组。
```
- 例子：
```
$$
...
- [下载](http://file.ericp.cn/work/mathjax_cmdeditor.md) 
- [Typora入门（中文版）](https://www.simon96.online/2018/10/18/Typora%E5%85%A5%E9%97%A8%EF%BC%88%E4%B8%AD%E6%96%87%E7%89%88%EF%BC%89/)
